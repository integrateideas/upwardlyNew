        ...
        <div class="panel-body">
            ...
            <?php echo $this->Form->input('vendor_id', ['value' =>$loggedInUser['vendor_id'],'type'=>'hidden']);?>
                ...
                <?= $this->Form->label('points', __('Points'), ['class' => ['col-sm-2', 'control-label']]); ?>
                    <div class="col-sm-10">
                        <?= $this->Form->input('points', ['id'=>'input-points','label' => false, "type"=>"number",['class' => 'form-control']]); ?>
                    </div>
                </div>
                <div class="hr-line-dashed"></div>
                <div class="form-group">
                ...
                <?= $this->Form->label('action_id', __('Action'), ['class' => ['col-sm-2', 'control-label']]); ?>
                    <div class="col-sm-10">
                    <?= $this->Form->input('vendor_badge_action[0].vendor_action_id', ['options' => $vendorActions, 'label' => false, 'class' => 'form-control','value' => $vendorBadge->vendor_badge_actions[0]->vendor_action_id]); ?>
                        <div class="form-group">
                ...
                <?= $this->Form->label('frequency', __('Frequency'), ['class' => ['col-sm-2', 'control-label']]); ?>
                    <div class="col-sm-10">
                        <?= $this->Form->input('vendor_badge_action[0].frequency', ['id'=>'frequency','label' => false,"min"=>1, "type"=>"number",'value' => $vendorBadge->vendor_badge_actions[0]->frequency,['class' => 'form-control']]); ?>
                    </div>
                </div>
                <div class="hr-line-dashed"></div>
                <div class="form-group">
